...
namespace MvcCv.Controllers
{
    public class DeneyimController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(degerler);  // listeleme deneyimrepository genericrepository den kalıtım aldığı için yazıdığımız metotları kullananabiliyoruz
        }
        ...
        [HttpGet]
        public ActionResult DeneyimGetir(int id) // ilgili id deneyimi getir 
        {
            TblDeneyimlerim t = repo.Find(x => x.ID == id);
